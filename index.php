...
<head>
    ...
    <style>
        ...
        .link { display: inline-block; margin-right: 15px; padding: 5px 10px; background: #f0f0f0; cursor: pointer; transition: background 0.3s; }
...
<ul class="menu">
    ...
    <li><a href="#4" id="item4" class="link">Пункт 4</a></li>
</ul>
